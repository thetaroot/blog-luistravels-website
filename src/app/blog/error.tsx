...
export default function BlogError({ error, reset }: BlogErrorProps) {
  useEffect(() => {
    // Log blog-specific error
    console.error('Blog section error:', error)
    
    // Track blog errors specifically for SEO monitoring
    ...
    <div className="min-h-screen flex items-center justify-center px-6">
      <div className="text-center max-w-2xl">
        ...
        <p className="text-xl text-dark/70 mb-8 leading-relaxed">
          Something went wrong while loading the travel stories. 
          Even the best adventures sometimes hit unexpected bumps!
        </p>

        {/* Development error details */}
        {process.env.NODE_ENV === 'development' && (
          <div className="bg-red-100 border border-red-300 rounded-lg p-4 mb-8 text-left">
            <h3 className="font-semibold text-red-800 mb-2">Blog Error Details:</h3>
        ...
        <div className="bg-pure-white rounded-2xl p-8 shadow-lg border border-dark/5">
          ...
          <p className="text-dark/70 mb-6">
            Explore other parts of the journey while we get the stories back online.
          </p>
